...
<div class="container content">
	<div class="row">	
		<div class="col s12 white-text center-align" style="margin-top:10px;padding:0px;">
			<h4 style="font-weight:300;letter-spacing:1px;">Login</h4>
		</div>		
	</div>
</div>
				...
				<div class="card-panel z-depth-2" style="padding:5px;padding-bottom:0px;">
						...
						<div class="row">
							<form class="col s12" id="stu_form" name="stu_form" autocomplete="off" style="padding-top:10px;">
								...
								<div class="input-field col s12 center-align" id="stu_btn_div">
									<button type="submit" class="btn-large waves-effect waves-light blue lighten-1" id="stu_btn" name="stu_btn" style="width:100%;letter-spacing:1px;">Login</button>
								</div>	
							</form>
						</div>	
					</div>										
						...
						<div class="row">
							<form class="col s12" id="exp_form" name="exp_form" autocomplete="off" style="padding-top:10px;">	
								...
								<div class="input-field col s12 center-align" id="exp_btn_div">
									<button type="submit" class="btn-large waves-effect waves-light blue lighten-1" id="exp_btn" name="exp_btn" style="width:100%;letter-spacing:1px;">Login</button>
								</div>	
							</form>
						</div>	
					</div>
					...
					<div class="row">
						<div class="col s12 m12 l12">
							<h6 style="padding:5px;">Need An account? <a href="signup.php">SignUp Here...</a></h6>
						</div>
					</div>
...
<script>
	$(document).on("submit", "#stu_form", function(event){
		...
		var formData={ stu_btn:"stu_log", mbl:mbl, psw:psw };		
		
		$.ajax({
			method: "POST",
			url: "php_includes/get-login.php",
			data: formData
		}).done(function(msg){
			$("#loader-btn").remove();
			$("#stu_btn_div").html("<button type='submit' class='btn-large waves-effect waves-light blue lighten-1' id='stu_btn' name='stu_btn' style='width:100%;letter-spacing:1px;'>Login</button>");												
			if(msg!="success"){								
...
<script>
	$(document).on("submit", "#exp_form", function(event){
		...
		var formData={ exp_btn:"exp_log", mbl:mbl, psw:psw };		
		...
		$.ajax({
			...
			if(msg!="success"){		
				$("#loader-btn").remove();
				$("#exp_btn_div").html("<button type='submit' class='btn-large waves-effect waves-light blue lighten-1' id='exp_btn' name='exp_btn' style='width:100%;letter-spacing:1px;'>Login</button>");												
