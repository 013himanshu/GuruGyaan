...
<?php
			include('conx.php');
			if($stmt = $conn->prepare("SELECT ques.q_id, ques.ques, category.value, answers.a_id, answers.answer FROM ques, category, answers WHERE ques.category=category.c_id AND ques.q_id=answers.q_id AND answers.answer_by=? ORDER BY ques.add_date DESC, ques.add_time DESC")){
						...
						echo '<div class="col s12 m12 l12">
							<div class="card white">
								...
								<div class="card-action" style="padding:10px;">						
									<a href="exp-edit.php?q_id='.$q_id.'&a_id='.$a_id.'" class="blue-grey-text text-darken-1">edit...</a>									
								</div>
							</div>
						</div>';
					}
